...
import { TRACK_1_PROBLEMS, TRACK_2_PROBLEMS } from "@/lib/data"; // <-- 1. IMPORT TRACK_2_PROBLEMS
  ...
  return (
    <div className="py-32 bg-dark-bg">
      <div className="container mx-auto px-4">
          ...
          <div className="space-y-8">
            {TRACK_1_PROBLEMS.map((problem, index) => (
              ...
              >
                ...
                {/* Conditionally render Datasets section */}
        ...
        {/* --- 2. REPLACED THE OLD PLACEHOLDER WITH THIS NEW DYNAMIC SECTION --- */}
        {/* Track 2 Section */}
        <div>
